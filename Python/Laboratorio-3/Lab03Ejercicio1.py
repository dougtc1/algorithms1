...
#
# Variables:
#   seleccion : integer // Variable que almacena el valor de la opcion escogida
#   resultado : float // Variable que almacena el valor de la operacion hecha
#   largo : float // Variable que almacena el largo de una habitacion
#   ancho : float // Variable que almacena el ancho de una habitacion
#   radio : float // Variable que almacena el radio de una circunferencia
...
try:
  assert (((seleccion==1) and resultado==largo*ancho and resultado>0) or \
            ((seleccion==2) and resultado==(radio*radio)*pi and resultado>0) or \
...
# Salida de datos
print("El resultado de la opcion escogida es:",'%.4f'%resultado)
